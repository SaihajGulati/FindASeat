        ...
        buildingsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    // For example:
                    buildingsRef.child("b1").setValue(new Building("b1", "Leavey Library", "Library", 330, 800, 1700));
                    buildingsRef.child("b2").setValue(new Building("b2", "Taper Hall", "Lecture Building", 80, 800, 1700));
                    buildingsRef.child("b3").setValue(new Building("b3", "Fertitta Hall", "This building is LEED certified...", 250, 800, 1700));
